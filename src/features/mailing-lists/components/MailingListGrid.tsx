...
export function MailingListGrid() {
  const { localLists, selectedListId, setSelectedListId } =
    useMLWorkspaceStore();
        ...
        return (
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <span
                className={`text-[10px] px-2 py-0.5 rounded-full border ${list.isActive ? "bg-green-500/10 text-green-500 border-green-500/20" : "bg-surface-2 text-text-muted border-border"}`}
              >
